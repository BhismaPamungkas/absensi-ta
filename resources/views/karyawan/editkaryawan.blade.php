                            ...
                            <form method="post" action="{{ url('/pegawai/proses-edit/'.$karyawan->id) }}" enctype="multipart/form-data">
                                ...
                                <!-- <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="hidden" class="form-control money @error('lembur') is-invalid @enderror" name="lembur" value="0">
                                            <!-- <div class="input-group-text">
                                                <span>/ Jam</span>
                                            </div>
                                            @error('lembur')
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col mb-4">
                                        ...
                                        <div class="input-group mb-3"> -->
                                            <input type="hidden" class="form-control money @error('bonus_pribadi') is-invalid @enderror" name="bonus_pribadi" value="0">
                                            <!-- <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                            @error('bonus_pribadi')
                                ...
                                <div class="row">
                                    <!-- <div class="col-6 mb-4">
                                        ...
                                        <div class="input-group mb-3"> -->
                                            <input type="hidden" class="form-control money @error('bonus_team') is-invalid @enderror" name="bonus_team" value="0">
                                            <!-- <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                            @error('bonus_team')
                                    ...
                                    <!-- <div class="col-6 mb-4">
                                        ...
                                        <div class="input-group mb-3"> -->
                                            <input type="hidden" class="form-control money @error('bonus_jackpot') is-invalid @enderror" name="bonus_jackpot" value="0">
                                            <!-- <div class="input-group-text">
                                                <span>/ Bulan</span>
                                            </div>
                                            @error('bonus_jackpot')
