            ...
            <div class="card">
                <form method="post" action="{{ url('/payroll/'.$data->id.'/update') }}" enctype="multipart/form-data" class="p-4">
                    ...
                    <div class="row">
                        <!-- <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3"> -->
                                    <input type="hidden" class="form-control money @error('total_reimbursement') is-invalid @enderror" name="total_reimbursement" value="0">
                        ...
                        <div class="col mb-4">
                            <div class="card p-4">
                                <label for="jumlah_mangkir">Tanpa Keterangan</label>
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-text">
                                        <span>Uang Tanpa Keterangan</span>
                                    </div>
                                    @error('uang_mangkir')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                    ...
                    <div class="row">
                         <!-- <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3"> -->
                                    <input type="hidden" class="form-control @error('jumlah_lembur') is-invalid @enderror" name="jumlah_lembur" value="0">
                                    <!-- <div class="input-group-text">
                                        <span>/ Jam</span>
                                    </div>
                                    @error('jumlah_lembur')
                                ...
                                <div class="input-group mb-3"> -->
                                    <input type="hidden" class="form-control money @error('uang_lembur') is-invalid @enderror" id="uang_lembur" name="uang_lembur" value="0">
                                    <!-- <div class="input-group-text">
                    ...
                    <div class="row">
                         <!-- <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3"> -->
                                    <input type="hidden" class="form-control money @error('bonus_pribadi') is-invalid @enderror" id="bonus_pribadi" style="background-color: orange" name="bonus_pribadi" value="0">
                                    <!-- <div class="input-group-text">
                                ...
                                <div class="input-group mb-3"> -->
                                    <input type="hidden" class="form-control money @error('bonus_team') is-invalid @enderror" id="bonus_team" name="bonus_team" style="background-color: orange" value="0">
                                    <!-- <div class="input-group-text">
                                ...
                                <div class="input-group mb-3"> -->
                                    <input type="hidden" class="form-control money @error('bonus_jackpot') is-invalid @enderror" id="bonus_jackpot" style="background-color: orange" name="bonus_jackpot" value="0">
                                    <!-- <div class="input-group-text">
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3"> -->
                                    <input type="hidden" class="form-control money @error('saldo_kasbon') is-invalid @enderror" name="saldo_kasbon" value="0" readonly>
                                    <!-- <div class="input-group-text">
                                ...
                                <!-- <div class="input-group mb-3"> -->
                                    <input type="hidden" class="form-control money @error('bayar_kasbon') is-invalid @enderror" id="bayar_kasbon" name="bayar_kasbon" value="0">
                                    <!-- <div class="input-group-text">
