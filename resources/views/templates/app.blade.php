    ...
    <div class="bottom-navigation-bar">
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                ...
                <li class="{{ Request::is('penugasan-kerja*') ? 'active' : '' }}"><a class="fw_4 d-flex justify-content-center align-items-center flex-column"
                        href="{{ url('/penugasan-kerja') }}"><svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <circle cx="12.25" cy="12" r="9.5" stroke="{{ Request::is('penugasan-kerja*') ? '#0000FF' : '#717171' }}" />
                            <path
                                ...
                                stroke="{{ Request::is('penugasan-kerja*') ? '#0000FF' : '#717171' }}" stroke-width="1.25" />
                        </svg>
                        Penugasan</a> </li>
