...
Route::get('/data-lembur', [LemburController::class, 'dataLembur'])->middleware('role:admin|hrd|Direktur|Operasional');
Route::post('/data-lembur/approval/{id}', [LemburController::class, 'approval'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
...
Route::get('/data-cuti', [CutiController::class, 'dataCuti'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
Route::get('/data-cuti/tambah', [CutiController::class, 'tambahAdmin'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
Route::post('/data-cuti/getuserid', [CutiController::class, 'getUserId'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
Route::post('/data-cuti/proses-tambah', [CutiController::class, 'tambahAdminProses'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
Route::delete('/data-cuti/delete/{id}', [CutiController::class, 'deleteAdmin'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
Route::get('/data-cuti/edit/{id}', [CutiController::class, 'editAdmin'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
Route::put('/data-cuti/edit-proses/{id}', [CutiController::class, 'editAdminProses'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
...
Route::get('/lokasi-kantor/pending-location', [LokasiController::class, 'pendingLocation'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
Route::put('/lokasi-kantor/update-pending-location/{id}', [LokasiController::class, 'UpdatePendingLocation'])->middleware('role:admin|hrd|kepala_cabang|Direktur|Operasional');
...
Route::get('/payroll/export', [PayrollController::class, 'exportPayroll'])->middleware('admin');
